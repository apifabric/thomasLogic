...
resourcename="thomaslogic"  # lower case, only
resourcegroup="thomaslogic_rg"
...
# git clone https://github.com/apilogicserver/thomaslogic.git
# cd thomaslogic
...
az group create --name thomaslogic_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group thomaslogic_rg --sku S1 --is-linux
az container create --resource-group thomaslogic_rg --name thomaslogic --image apilogicserver/thomaslogic:latest --dns-name-label thomaslogic --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//thomaslogic.westus.azurecontainer.io:5656'
